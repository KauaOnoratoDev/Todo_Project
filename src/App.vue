...
<template>
  <div class="container">
    ...
    <form @submit.prevent="cadastraTarefa()">
      <div class="row">
        <div class="col">
          <input @change="evento => estado.tarefaTemp = evento.target.value" :value="estado.tarefaTemp" required type="text" placeholder="Digite aqui a descrição da tarefa" class="form-control">
        </div>
        <div class="col-md-1">
